...
import loadingGif from '../../assets/images/fishflix.gif';
...
const Home = (props: Props) => {
    ...
    if (loading) {
        return (
            <div className="loading-screen" style={{ background: 'black', height: '100vh', display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
        ...
        <div className='home'>
            ...
            <div className="main-content bg-black-2">
                ...
                <section className="about py-3">
                    <Wrapper>
                        <p className='text-light-gray text-xs sm:text-sm mt-2'><span className='text-white text-sm'>Fish<span className='text-dark-teal'>Flix</span></span> - A better place to watch your favourite Films and TV Shows.</p>
